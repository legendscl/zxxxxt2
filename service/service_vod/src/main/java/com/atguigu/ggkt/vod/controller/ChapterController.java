...
public class ChapterController {
    ...
    //1 大纲列表（章节和小节列表）
    @ApiOperation("大纲列表")
    @GetMapping("getNestedTreeList/{courseId}")//49.49.bq.bq
    ...
    //4 修改-最终实现
    @PostMapping("update")//54.54.bq.bq
