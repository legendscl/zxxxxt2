...
public class CourseServiceImpl extends ServiceImpl<CourseMapper, Course> implements CourseService {
    ...
    @Autowired//41.41.bq.bq
    private TeacherService teacherService;

    @Autowired//45.45.bq.bq
...
//
    ...
    //根据课程id查询发布课程信息
    @Override
    public CoursePublishVo getCoursePublishVo(Long id) {//58..58
...
//    }
//
    //获取这些id对应名称，进行封装，最终显示//43.43.bq.bq
